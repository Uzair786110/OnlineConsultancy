			...
			<div class="row">
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						<h2 class="ftco-heading-2 logo d-flex align-items-center"><a href="#"><img src="images/logo_dark.png" width="35" height="35" alt=""><span>Medex</span></a></h2>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p class="mb-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://AptechLearning.com" target="_blank">Aptech</a>
